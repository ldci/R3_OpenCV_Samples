...
with cv [
    ...
    kernel: getStructuringElement 1 kSize 1 		;--prepare the kernel 
    dst1: erode src none kernel -1x-1 iter         	;--erode the source image
    dst2: dilate src none kernel -1x-1 iter        	;--dilate the source image
